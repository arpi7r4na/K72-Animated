        ...
        <div ref={fullScreenRef} id='fullscreennav' className='fullscreennav hidden text-white overflow-hidden h-screen w-full z-50 absolute'>
            ...
            <div ref={fullNavLinksRef} className='relative'>
                <div className="navlink flex w-full justify-between lg:p-5 p-2 items-start">
                    ...
                    <div onClick={() => {
                        setNavOpen(false)
                    }} className='lg:h-10 h-10 w-15 lg:w-20 relative cursor-pointer'>
                        <div className='absolute top-1/2 left-1/2 h-6 w-[2px] bg-[#D3FD50] -translate-x-1/
                        2 -translate-y-1/2 rotate-45'></div>
                        <div className='absolute top-1/2 left-1/2 h-6 w-[2px] bg-[#D3FD50] -translate-x-1/2 -translate-y-1/2 -rotate-45'></div>

                    </div>
                </div>
                <div className=' py-25'>
                    <div className='link origin-top relative border-t-1 border-white'>
                        <h1 className='font-[font2] text-5xl lg:text-[8vw] text-center lg:leading-[0.9] lg:pt-8 pt-3 uppercase'>Projets</h1>
                        <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50]'>
                            <div className='moveX flex items-center'>
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-4xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Pour Tout voir</h2>
